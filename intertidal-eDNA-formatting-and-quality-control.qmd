...
### Calulate unassigned ASVs before merging

```{r}
#| label: define-unassigned
...
```{r}
#| label: cal-unassigned-asvs

#SCH --------

# SCH - 18S ---
total_asvs_SCH_18S <- length(SCH_taxa_18S$ASV) # Count total ASVs
unassigned_asvs_SCH_18S <- SCH_taxa_18S[
  grepl(paste(unassigned_phrases, collapse = "|"), SCH_taxa_18S$taxonomy) |
    is.na(SCH_taxa_18S$taxonomy),
]

removed_asvs_SCH_18S <- length(unassigned_asvs_SCH_18S$ASV) # Count ASVs that will be removed

percentage_unassigned_SCH_18S <- (removed_asvs_SCH_18S / total_asvs_SCH_18S) * 100 # Calculate percentage removed
cat("Percentage of ASVs unassigned for SCH-18S:", round(percentage_unassigned_SCH_18S, 2), "%\n")

# SCH - CO1 ---
total_asvs_SCH_CO1 <- length(SCH_taxa_CO1$ASV) # Count total ASVs
unassigned_asvs_SCH_CO1 <- SCH_taxa_CO1[
  grepl(paste(unassigned_phrases, collapse = "|"), SCH_taxa_CO1$taxonomy) |
    is.na(SCH_taxa_CO1$taxonomy),
]

removed_asvs_SCH_CO1 <- length(unassigned_asvs_SCH_CO1$ASV) # Count ASVs that will be removed

percentage_unassigned_SCH_CO1 <- (removed_asvs_SCH_CO1 / total_asvs_SCH_CO1) * 100 # Calculate percentage removed
cat("Percentage of ASVs unassigned for SCH-CO1:", round(percentage_unassigned_SCH_CO1, 2), "%\n")

#NW --------

# NW - 18S ---
total_asvs_NW_18S <- length(NW_taxa_18S$ASV) # Count total ASVs
unassigned_asvs_NW_18S <- NW_taxa_18S[
  grepl(paste(unassigned_phrases, collapse = "|"), NW_taxa_18S$taxonomy) |
    is.na(NW_taxa_18S$taxonomy),
]

removed_asvs_NW_18S <- length(unassigned_asvs_NW_18S$ASV) # Count ASVs that will be removed

percentage_unassigned_NW_18S <- (removed_asvs_NW_18S / total_asvs_NW_18S) * 100 # Calculate percentage removed
cat("Percentage of ASVs unassigned for NW-18S:", round(percentage_unassigned_NW_18S, 2), "%\n")

# NW - CO1 ---
total_asvs_NW_CO1 <- length(NW_taxa_CO1$ASV) # Count total ASVs
unassigned_asvs_NW_CO1 <- NW_taxa_CO1[
  grepl(paste(unassigned_phrases, collapse = "|"), NW_taxa_CO1$taxonomy) |
    is.na(NW_taxa_CO1$taxonomy),
]

removed_asvs_NW_CO1 <- length(unassigned_asvs_NW_CO1$ASV) # Count ASVs that will be removed

percentage_unassigned_NW_CO1 <- (removed_asvs_NW_CO1 / total_asvs_NW_CO1) * 100 # Calculate percentage removed
cat("Percentage of ASVs unassigned for NW-CO1:", round(percentage_unassigned_NW_CO1, 2), "%\n")

# SW -----------

# SW - 18S ---
total_asvs_SW_18S <- length(SW_taxa_18S$ASV) # Count total ASVs
unassigned_asvs_SW_18S <- SW_taxa_18S[
  grepl(paste(unassigned_phrases, collapse = "|"), SW_taxa_18S$taxonomy) |
    is.na(SW_taxa_18S$taxonomy),
]

removed_asvs_SW_18S <- length(unassigned_asvs_SW_18S$ASV) # Count ASVs that will be removed

percentage_unassigned_SW_18S <- (removed_asvs_SW_18S / total_asvs_SW_18S) * 100 # Calculate percentage removed
cat("Percentage of ASVs unassigned for SW-18S:", round(percentage_unassigned_SW_18S, 2), "%\n")

# SW - CO1 ---
total_asvs_SW_CO1 <- length(SW_taxa_CO1$ASV) # Count total ASVs
unassigned_asvs_SW_CO1 <- SW_taxa_CO1[
  grepl(paste(unassigned_phrases, collapse = "|"), SW_taxa_CO1$taxonomy) |
    is.na(SW_taxa_CO1$taxonomy),
]

removed_asvs_SW_CO1 <- length(unassigned_asvs_SW_CO1$ASV) # Count ASVs that will be removed

percentage_unassigned_SW_CO1 <- (removed_asvs_SW_CO1 / total_asvs_SW_CO1) * 100 # Calculate percentage removed
cat("Percentage of ASVs unassigned for SW-CO1:", round(percentage_unassigned_SW_CO1, 2), "%\n")

# NE -----------

# NE - 18S ---
total_asvs_NE_18S <- length(NE_taxa_18S$ASV) # Count total ASVs
unassigned_asvs_NE_18S <- NE_taxa_18S[
  grepl(paste(unassigned_phrases, collapse = "|"), NE_taxa_18S$taxonomy) |
    is.na(NE_taxa_18S$taxonomy),
]

removed_asvs_NE_18S <- length(unassigned_asvs_NE_18S$ASV) # Count ASVs that will be removed

percentage_unassigned_NE_18S <- (removed_asvs_NE_18S / total_asvs_NE_18S) * 100 # Calculate percentage removed
cat("Percentage of ASVs unassigned for NE-18S:", round(percentage_unassigned_NE_18S, 2), "%\n")

# NE - CO1 ---
total_asvs_NE_CO1 <- length(NE_taxa_CO1$ASV) # Count total ASVs
unassigned_asvs_NE_CO1 <- NE_taxa_CO1[
  grepl(paste(unassigned_phrases, collapse = "|"), NE_taxa_CO1$taxonomy) |
    is.na(NE_taxa_CO1$taxonomy),
]

removed_asvs_NE_CO1 <- length(unassigned_asvs_NE_CO1$ASV) # Count ASVs that will be removed

percentage_unassigned_NE_CO1 <- (removed_asvs_NE_CO1 / total_asvs_NE_CO1) * 100 # Calculate percentage removed
cat("Percentage of ASVs unassigned for NE-CO1:", round(percentage_unassigned_NE_CO1, 2), "%\n")

# CN -----------

# CN - 18S ---
total_asvs_CN_18S <- length(CN_taxa_18S$ASV) # Count total ASVs
unassigned_asvs_CN_18S <- CN_taxa_18S[
  grepl(paste(unassigned_phrases, collapse = "|"), CN_taxa_18S$taxonomy) |
    is.na(CN_taxa_18S$taxonomy),
]

removed_asvs_CN_18S <- length(unassigned_asvs_CN_18S$ASV) # Count ASVs that will be removed

percentage_unassigned_CN_18S <- (removed_asvs_CN_18S / total_asvs_CN_18S) * 100 # Calculate percentage removed
cat("Percentage of ASVs unassigned for CN-18S:", round(percentage_unassigned_CN_18S, 2), "%\n")

# CN - CO1 ---
total_asvs_CN_CO1 <- length(CN_taxa_CO1$ASV) # Count total ASVs
unassigned_asvs_CN_CO1 <- CN_taxa_CO1[
  grepl(paste(unassigned_phrases, collapse = "|"), CN_taxa_CO1$taxonomy) |
    is.na(CN_taxa_CO1$taxonomy),
]

removed_asvs_CN_CO1 <- length(unassigned_asvs_CN_CO1$ASV) # Count ASVs that will be removed

percentage_unassigned_CN_CO1 <- (removed_asvs_CN_CO1 / total_asvs_CN_CO1) * 100 # Calculate percentage removed
cat("Percentage of ASVs unassigned for CN-CO1:", round(percentage_unassigned_CN_CO1, 2), "%\n")

# overall co1
total_unassigned_CO1 <-((percentage_unassigned_CN_CO1 +
                        percentage_unassigned_NE_CO1 +
                        percentage_unassigned_SW_CO1 +
                        percentage_unassigned_NW_CO1 +
                        percentage_unassigned_SCH_CO1) / 500)  * 100
cat("Percentage of ASVs unassigned for CO1:", round(total_unassigned_CO1, 2), "%\n")

# overall 18S
total_unassigned_18S <-((percentage_unassigned_CN_18S +
                        percentage_unassigned_NE_18S +
                        percentage_unassigned_SW_18S +
                        percentage_unassigned_NW_18S +
                        percentage_unassigned_SCH_18S) / 500)  * 100
cat("Percentage of ASVs unassigned for 18S:", round(total_unassigned_18S, 2), "%\n")

# overall 
total_unassigned_overall <-((total_unassigned_18S + 
                               total_unassigned_CO1) / 200)  * 100
cat("Percentage of ASVs unassigned for overall:", round(total_unassigned_overall, 2), "%\n")
```
...
total_asvs <- length(unique(eDNA_long_data$ASV)) # Count total ASVs before filtering
total_asvs

unassigned_asvs <- eDNA_long_data[grepl(paste(unassigned_phrases, collapse = "|"), eDNA_long_data$taxonomy), ]
removed_asvs <- length(unique(unassigned_asvs$ASV)) # Count ASVs that will be removed
removed_asvs
...
taxa$scientificname <- as.factor(taxa$scientificname)
taxa <- taxa[order(taxa$scientificname),] #order alphabetically to match other ps elements
rownames(taxa) <-taxa$scientificname
taxa <- as.matrix(taxa)
```
...
We can also repeat the last few steps but group by `scientificname` to get a taxa-level `otu_table` . In my further analyses, taxa-level detection are appropriate and so we will move forward using this `otu_table`.
...
species_reads_long_taxa <- eDNA_long_data_removefailed %>%
  select(ASV, scientificname, reads, fullID) %>%
  mutate(across(c(ASV, scientificname, fullID), as.factor)) %>%
  distinct()

species_reads_long_taxa_grouped <- species_reads_long_taxa %>% 
  group_by(scientificname, fullID) %>% 
...
#order names alphabetically
species_reads_wide_taxa<- species_reads_wide_taxa[order(species_reads_wide_taxa$scientificname),] #order rows alphabetically
...
species_reads_wide_taxa <- species_reads_wide_taxa %>% column_to_rownames(var="scientificname")
...
plot_bar(controls_shared_taxa, "fullID", fill = "scientificname")
```
...
sample_data(phylo_eDNA_decontam)$shorePosition[sample_data(phylo_eDNA_decontam)$shorePosition == "Mid "] <- "Low"
...
It's good practice to remove any samples with the low read depth to prevent sampling bias driving ecological patterns. We are going to explore the distribution of read depths across samples to make a decision on a minimum depth threshold.
...
# save the taxa list before filtering for saving later
full_nontarget_phylo <- phylo_eDNA_decontam_filtered
...
Now let's save each of the lists (target and non-target for each primer) for supplemntary information.

```{r}
#| label: save-SM-tables-taxa

# explore
full_nontarget_phylo
phylo_eDNA_decontam_filtered

# get only non-target
taxa_to_remove <- taxa_names(phylo_eDNA_decontam_filtered)
nontarget_only_phylo <- prune_taxa(!(taxa_names(full_nontarget_phylo) %in% taxa_to_remove), full_nontarget_phylo)

# save only genus and species level for supp
tax_table_data <- tax_table(phylo_eDNA_decontam_filtered)
keep_taxa <- rownames(tax_table_data)[tax_table_data[, "rank"] %in% c("Species", "Genus")]
phylo_target_genus_species <- prune_taxa(keep_taxa, phylo_eDNA_decontam_filtered)

tax_table_data_nontarget <- tax_table(nontarget_only_phylo)
keep_taxa_nontarget <- rownames(tax_table_data_nontarget)[tax_table_data_nontarget[, "rank"] %in% c("Species", "Genus")]
phylo_nontarget_genus_species <- prune_taxa(keep_taxa_nontarget, nontarget_only_phylo)

# save non-target list by primer
nontarget_CO1 <- ps_filter(phylo_nontarget_genus_species, primer == "CO1")
nontarget_CO1_list <- tax_table(nontarget_CO1)
write.csv(nontarget_CO1_list, file = "Processed_data/nontarget_CO1_taxa_list.csv", row.names = FALSE)

nontarget_18S <- ps_filter(phylo_nontarget_genus_species, primer == "18S")
nontarget_18S_list <- tax_table(nontarget_18S)
write.csv(nontarget_18S_list, file = "Processed_data/nontarget_18S_taxa_list.csv", row.names = FALSE)

# save target list by primer
target_CO1 <- ps_filter(phylo_target_genus_species, primer == "CO1")
target_CO1_list <- tax_table(target_CO1)
write.csv(target_CO1_list, file = "Processed_data/target_CO1_taxa_list.csv", row.names = FALSE)

target_18S <- ps_filter(phylo_target_genus_species, primer == "18S")
target_18S_list <- tax_table(target_18S)
write.csv(target_18S_list, file = "Processed_data/target_18S_taxa_list.csv", row.names = FALSE)
```
...
We have now tidied, decontaminated, and filtered our eDNA metabarcoding data and used a variety of visualizations to quality check our data. Further ecological analyses will be presented in separate Markdown documents using the data generated in this workflow.
