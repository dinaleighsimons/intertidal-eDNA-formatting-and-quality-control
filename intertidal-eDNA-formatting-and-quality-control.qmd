...
Let's also convert it to a long data format incase we need it for further analyses.
...
First, I stop scientific notation being presented in plots.
...
Let's set-up some functions we'll use later on to extract random pieces of information from our data. Note: these functions only work currently for the format of IDs I have in this dataset. They made need altering for other datasets.
...
reads_histo <- ggplot(sample_depths_decontam_nozero, aes(x=reads_prefilter, fill = primer, colour = primer)) + 
  ...
  xlab("Sample depth") + ylab("Sample frequency") +
...
reads_histo_together <- cowplot::plot_grid(reads_histo, reads_histo_filter, labels = c("a", "b"), ncol = 1)

reads_histo_together

#save
ggsave(reads_histo_together, filename = "Figures/sample_depth_histogram_together.png", height = 200, width = 220, dpi = 300, units = "mm")
```

#### Reads by site

Let's look at reads over sites.
...
reads_boxplot_sites_together <- cowplot::plot_grid(reads_boxplot_sites, reads_boxplot_sites_filter, labels = c("a", "b"), ncol = 1) 

reads_boxplot_sites_together  

#save 
ggsave(reads_boxplot_sites_together, filename = "Figures/reads_boxplot_sites_together.png", height = 300, width = 250, dpi = 300, units = "mm")
```
...
#Find taxa that are shared among a certain number of controls
replicates_shared_taxa = filter_taxa(phylo_replicates, 
                                     function(x) sum(x >= 1) == (2), TRUE)

plot_bar(replicates_shared_taxa, "fieldID", fill = "phylum")
```
...
ggsave(filename = "Figures/run_replicates_taxa_plot_SW_curated_98.png", plot = run_replicates_taxa_plot_SW,
...
ggsave(filename = "Figures/dis_CO1_matrix_SW_curated_98.png", plot = dis_CO1_matrix_SW ,
       device = "png", dpi = 300, units = "mm", height = 200, width = 250)
...
ggsave(filename = "Figures/dis_18S_matrix_SW_curated_98.png", plot = dis_18S_matrix_SW ,
       device = "png", dpi = 300, units = "mm", height = 200, width = 250)
```
...
ggsave(filename = "Figures/run_replicates_taxa_plot_SCH_curated_98.png", plot = run_replicates_taxa_plot_SCH,
       device = "png", dpi = 300, units = "mm", height = 150, width = 250)
...
ggsave(filename = "Figures/dis_CO1_matrix_SCH_curated_98.png", plot = dis_CO1_matrix_SCH ,
       device = "png", dpi = 300, units = "mm", height = 150, width = 250)
...
ggsave(filename = "Figures/dis_18S_matrix_SCH_curated_98.png", plot = dis_18S_matrix_SCH ,
       device = "png", dpi = 300, units = "mm", height = 200, width = 250)
```
...
ggsave(filename = "Figures/run_replicates_taxa_plot_CN_curated_98.png", plot = run_replicates_taxa_plot_CN,
       device = "png", dpi = 300, units = "mm", height = 150, width = 250)
...
ggsave(filename = "Figures/dis_CO1_matrix_CN_curated_98.png", plot = dis_CO1_matrix_CN ,
       device = "png", dpi = 300, units = "mm", height = 200, width = 250)
...
ggsave(filename = "Figures/dis_18S_matrix_CN_curated_98.png", plot = dis_18S_matrix_CN ,
       device = "png", dpi = 300, units = "mm", height = 200, width = 250)
```
...
ggsave(filename = "Figures/run_replicates_taxa_plot_NE_curated_98.png", plot = run_replicates_taxa_plot_NE,
       device = "png", dpi = 300, units = "mm", height = 150, width = 250)
...
ggsave(filename = "Figures/dis_CO1_matrix_NE_curated_98.png", plot = dis_CO1_matrix_NE,
       device = "png", dpi = 300, units = "mm", height = 200, width = 250)
...
ggsave(filename = "Figures/dis_18S_matrix_NE_curated_98.png", plot = dis_18S_matrix_NE ,
       device = "png", dpi = 300, units = "mm", height = 200, width = 250)
```
...
ggsave(filename = "Figures/run_replicates_taxa_plot_NW_curated_98.png", plot = run_replicates_taxa_plot_NW,
       device = "png", dpi = 300, units = "mm", height = 150, width = 250)
...
ggsave(filename = "Figures/dis_CO1_matrix_NW_curated_98.png", plot = dis_CO1_matrix_NW,
       device = "png", dpi = 300, units = "mm", height = 200, width = 250)
...
ggsave(filename = "Figures/dis_18S_matrix_NW_curated_98.png", plot = dis_18S_matrix_NW,
       device = "png", dpi = 300, units = "mm", height = 200, width = 250)
```

Join them together for export.
