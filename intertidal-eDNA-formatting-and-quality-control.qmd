...
This pipeline aims to bridge outputs from the bioinformatics processing (in this case, DADA2) to ecological community analyses. It collates resources from numerous different locations.
...
Let's set-up some functions we'll use later on to extract random pieces of information from our data. Note: these functions only work currently for the format of IDs I have in this data set. They made need altering for other data sets.
...
Before filtering. We shouldn't see negative or positive controls here anymore.
...
#### Overall visualization of dissimailrity 
